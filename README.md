...
性年齢別の例 `ndbm.load_age()` を示します。
都道府県別のデータを読み込みたい場合は `ndbm.load_pref()` を使用してください。
診療月別のデータを読み込みたい場合は `ndbm.load_month()` を使用してください（第10回以降のみ、歯科用薬剤は対象外）。
...
--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--
10|2023|内服|外来（院内）|112|催眠鎮静剤，抗不安剤|610443047|マイスリー錠５ｍｇ|錠|1129009F1025|24.2|0|4月|2023/04|2217181.25|0
10|2023|内服|外来（院内）|112|催眠鎮静剤，抗不安剤|610443047|マイスリー錠５ｍｇ|錠|1129009F1025|24.2|0|5月|2023/05|2193154.50|0
